...
const translations = {
  en: {
    ...
    contextLabel: "Write something about yourself or about other subjects (people, objects, places, situations) whose future you want to forecast. The more information you provide, the more accurate the forecast will be:",
    questionLabel: "Ask a question about the subject’s future that can be answered with YES or NO:",
...
For current situations: list all participants, the course of events so far, and key facts.`,
  ...
  sr: {
    ...
    contextLabel: "Napišite nešto o sebi ili o drugim subjektima (osobama, predmetima, mestima, situacijama) čiju budućnost želite da predvidite. Što više informacija unesete, prognoza će biti preciznija:",
    questionLabel: "Postavite pitanje o budućnosti subjekta koje može imati odgovor DA ili NE.",
...
Za trenutne situacije: navedite sve učesnike, dosadašnji tok događaja i ključne činjenice.`,
  ...
  es: {
    ...
    contextLabel: "Escribe algo sobre ti o sobre otros temas (personas, objetos, lugares, situaciones) cuyo futuro deseas pronosticar. Cuanta más información proporciones, más precisa será la predicción:",
    questionLabel: "Formula una pregunta sobre el futuro del tema que pueda responderse con SÍ o NO:",
...
Para situaciones actuales: indique todos los participantes, el desarrollo hasta el momento y los hechos clave.`,
  ...
  fr: {
    ...
    contextLabel: "Écrivez quelque chose sur vous-même ou sur d’autres sujets (personnes, objets, lieux, situations) dont vous souhaitez prévoir l’avenir. Plus vous fournissez d’informations, plus la prévision sera précise :",
    questionLabel: "Posez une question sur l’avenir du sujet qui puisse recevoir une réponse OUI ou NON :",
...
Pour des situations actuelles : indiquez tous les participants, le déroulement jusqu’à présent et les faits clés.`,
  ...
  de: {
    ...
    contextLabel: "Schreiben Sie etwas über sich selbst oder über andere Themen (Personen, Objekte, Orte, Situationen), deren Zukunft Sie prognostizieren möchten. Je mehr Informationen Sie angeben, desto genauer wird die Prognose:",
    questionLabel: "Stellen Sie eine Frage zur Zukunft des Themas, die mit JA oder NEIN beantwortet werden kann:",
...
Für aktuelle Situationen: Nennen Sie alle Beteiligten, den bisherigen Verlauf und die wichtigsten Fakten.`,
  ...
  pt: {
    ...
    contextLabel: "Escreva algo sobre você ou sobre outros assuntos (pessoas, objetos, lugares, situações) cujo futuro deseja prever. Quanto mais informações você fornecer, mais precisa será a previsão:",
    questionLabel: "Faça uma pergunta sobre o futuro do assunto que possa ser respondida com SIM ou NÃO:",
...
Para situações atuais: mencione todos os envolvidos, o andamento até o momento e os fatos principais.`,
  ...
  it: {
    ...
    contextLabel: "Scrivi qualcosa su di te o su altri argomenti (persone, oggetti, luoghi, situazioni) di cui vuoi prevedere il futuro. Più informazioni fornisci, più accurata sarà la previsione:",
    questionLabel: "Poni una domanda sul futuro dell’argomento a cui si possa rispondere SÌ o NO:",
...
Per situazioni attuali: indica tutti i partecipanti, lo svolgimento fino ad ora e i fatti principali.`,
  ...
  ru: {
    ...
    contextLabel: "Напишите что-нибудь о себе или о других темах (людях, объектах, местах, ситуациях), чьё будущее вы хотите прогнозировать. Чем больше информации вы предоставите, тем точнее будет прогноз:",
    questionLabel: "Задайте вопрос о будущем темы, на который можно ответить ДА или НЕТ:",
...
Для оценки текущих ситуаций: перечислите всех участников, ход событий до настоящего момента и основные факты.`,
  ...
  pl: {
    ...
    contextLabel: "Napisz coś o sobie lub o innych tematach (osobach, przedmiotach, miejscach, sytuacjach), których przyszłość chcesz prognozować. Im więcej informacji podasz, tym dokładniejsza będzie prognoza:",
    questionLabel: "Zadaj pytanie o przyszłość tematu, na które można odpowiedzieć TAK lub NIE:",
...
Dla bieżących sytuacji – podaj uczestników, dotychczasowy przebieg wydarzeń i kluczowe fakty.`,
  ...
  uk: {
    ...
    contextLabel: "Напишіть щось про себе або про інші теми (людей, об’єкти, місця, ситуації), майбутнє яких ви хочете спрогнозувати. Чим більше інформації ви надаєте, тим точнішим буде прогноз:",
    questionLabel: "Поставте запитання про майбутнє теми, на яке можна відповісти ТАК або НІ:",
...
Для поточних ситуацій – перелічіть усіх учасників, перебіг подій і ключові факти.`,
  ...
  tr: {
    ...
    contextLabel: "Kendiniz hakkında veya geleceğini tahmin etmek istediğiniz diğer konular (kişiler, nesneler, yerler, durumlar) hakkında bir şeyler yazın. Ne kadar çok bilgi verirseniz, tahmin o kadar doğru olur:",
    questionLabel: "Konu hakkında EVET veya HAYIR ile yanıtlanabilecek bir soru sorun:",
...
Mevcut bir durum için: tüm tarafları, olayın gidişatını ve önemli gerçekleri açıklayın.`,
  ...
  ar: {
    ...
    contextLabel: "اكتب شيئًا عن نفسك أو عن مواضيع أخرى (أشخاص، أشياء، أماكن، مواقف) تريد التنبؤ بمستقبلها. كلما قدّمت معلومات أكثر كانت التنبؤات أدقّ:",
    questionLabel: "اكتب سؤالًا عن مستقبل الموضوع يمكن الإجابة عنه بـ نَعَم أو لا:",
...
وفي حالة المواقف الحالية: اذكر جميع الأطراف، مجريات الأحداث حتى الآن، والحقائق الرئيسية.`,
  ...
  hi: {
    ...
    contextLabel: "अपने बारे में या अन्य विषयों (व्यक्ति, वस्तुएँ, स्थान, परिस्थितियाँ) के बारे में कुछ लिखें जिनका भविष्य आप पूर्वानुमान करना चाहते हैं। आप जितनी अधिक जानकारी देंगे, अनुमान उतना ही सटीक होगा:",
    questionLabel: "विषय के भविष्य के बारे में ऐसा प्रश्न पूछें जिसका उत्तर हाँ या नहीं में दिया जा सके:",
...
वर्तमान स्थितियों के लिए: सभी प्रतिभागियों, अब तक की घटनाओं और प्रमुख तथ्यों का उल्लेख करें।`,
  ...
  zh: {
    ...
    contextLabel: "请写一些关于你自己，或其他你想预测其未来的主题（人物、物品、地点、情境）。提供的信息越多，预测就会越准确：",
    questionLabel: "请提出一个关于该主题未来的、可以用“是”或“否”回答的问题：",
    sendButton: "提交问题",
  ...
  ja: {
    ...
    contextLabel: "将来を予測したい対象（人・物・場所・状況）について、あなた自身のことやそのほかのことを少し書いてください。情報が多いほど、予測は正確になります。",
    questionLabel: "対象の将来について、はい／いいえで答えられる質問を入力してください：",
    sendButton: "質問を送信",
