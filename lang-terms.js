...
function setLanguage(lang) {
  ...
  setHTMLAny ("terms-s1-1",     t.s1.p1);
  setHTMLAny ("terms-s1-2",     t.s1.p2);
  setTxtAny  ("terms-s1-3",     t.s1.p3);

  // 2 (ima <strong> i foot)
  setTxtAny  ("terms-s2-title", t.s2.title);
  setHTMLAny ("terms-s2-1",     t.s2.p1);
  setHTMLAny ("terms-s2-2",     t.s2.p2);
  setHTMLAny ("terms-s2-3",     t.s2.p3);
  setHTMLAny ("terms-s2-4",     t.s2.p4);
  setTxtAny  ("terms-s2-foot",  t.s2.foot);

  // 3 (pododeljci)
  setTxtAny  ("terms-s3-title",    t.s3.title);

  setHTMLAny ("terms-s3-1-title",  t.s3.d31);
  setTxtAny  ("terms-s3-1-1",      t.s3.d31_1);
  setTxtAny  ("terms-s3-1-2",      t.s3.d31_2);
  setHTMLAny ("terms-s3-1-note",   t.s3.d31_note);

  setHTMLAny ("terms-s3-2-title",  t.s3.d32);
  setHTMLAny ("terms-s3-2-1",      t.s3.d32_1);
  setHTMLAny ("terms-s3-2-2",      t.s3.d32_2);

  setHTMLAny ("terms-s3-3-title",  t.s3.d33);
  setTxtAny  ("terms-s3-3-1",      t.s3.d33_1);
  setTxtAny  ("terms-s3-3-2",      t.s3.d33_2);
  setHTMLAny ("terms-s3-3-eu-1",   t.s3.d33_eu_1);
  setTxtAny  ("terms-s3-3-eu-2",   t.s3.d33_eu_2);
  setTxtAny  ("terms-s3-3-eu-3",   t.s3.d33_eu_3);
  setTxtAny  ("terms-s3-3-eu-4",   t.s3.d33_eu_4);
  setHTMLAny ("terms-s3-3-note",   t.s3.d33_note);

  setHTMLAny ("terms-s3-4-title",  t.s3.d34);
  setTxtAny  ("terms-s3-4-1",      t.s3.d34_1);
  setTxtAny  ("terms-s3-4-2",      t.s3.d34_2);

  setHTMLAny ("terms-s3-5-title",  t.s3.d35);
  setTxtAny  ("terms-s3-5-1",      t.s3.d35_1);
  setTxtAny  ("terms-s3-5-2",      t.s3.d35_2);
  setTxtAny  ("terms-s3-5-3",      t.s3.d35_3);

  // 4
  setTxtAny ("terms-s4-title", t.s4.title);
  setTxtAny ("terms-s4-intro", t.s4.intro);
  setTxtAny ("terms-s4-1",     t.s4.p1);
  setTxtAny ("terms-s4-2",     t.s4.p2);
  setTxtAny ("terms-s4-3",     t.s4.p3);
  setTxtAny ("terms-s4-4",     t.s4.p4);
  setTxtAny ("terms-s4-5",     t.s4.p5);
  setTxtAny ("terms-s4-6",     t.s4.p6);
  setTxtAny ("terms-s4-7",     t.s4.p7);
  ...
  setTxtAny ("terms-s5-5",     t.s5.p5);
  setTxtAny ("terms-s5-6",     t.s5.p6);
  setTxtAny ("terms-s5-7",     t.s5.p7);

  // 6
  setTxtAny  ("terms-s6-title", t.s6.title);
  setTxtAny  ("terms-s6-intro", t.s6.intro);
  setTxtAny  ("terms-s6-1",     t.s6.p1);
  setTxtAny  ("terms-s6-2",     t.s6.p2);
  setTxtAny  ("terms-s6-3",     t.s6.p3);
  setTxtAny  ("terms-s6-4",     t.s6.p4);
  setHTMLAny ("terms-s6-5",     t.s6.p5);
  setTxtAny  ("terms-s6-foot",  t.s6.foot);
  ...
  setTxtAny ("terms-s8-1",     t.s8.p1);
  setTxtAny ("terms-s8-2",     t.s8.p2);
  ...
  setTxtAny  ("terms-s10-intro",   t.s10.intro);
  setHTMLAny ("terms-s10-1",       t.s10.p1);
  setHTMLAny ("terms-s10-2",       t.s10.p2);
  setHTMLAny ("terms-s10-3",       t.s10.p3);
  setHTMLAny ("terms-s10-no-storage", t.s10.nostore);

  // 11
  setTxtAny ("terms-s11-title", t.s11.title);
  setTxtAny ("terms-s11-1",     t.s11.p1);
  setTxtAny ("terms-s11-2",     t.s11.p2);
  setTxtAny ("terms-s11-3",     t.s11.p3);
  setTxtAny ("terms-s11-4",     t.s11.p4);
  ...
  setTxtAny ("terms-s17-2",     t.s17.p2);
